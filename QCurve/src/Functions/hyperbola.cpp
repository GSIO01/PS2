...
{
  static QString genFormula = QString("<math> <semantics> <mi>x</mi> <mo>(</mo> <mi>t</mi> <mo>)</mo> <mo>=</mo> <mi>a</mi> <mo>&middot;</mo> <mi>cosh</mi> <mo>(</mo> <mi>t</mi> <mo>)</mo> <mtext>,&ThickSpace;&ThickSpace;</mtext> <mi>y</mi> <mo>(</mo> <mi>t</mi> <mo>)</mo> <mo>=</mo> <mi>b</mi> <mo>&middot;</mo> <mi>sinh</mi> <mo>(</mo> <mi>t</mi> <mo>)</mo> <mtext>,&ThickSpace;&ThickSpace;</mtext> <mi>t</mi> <mo>&isin;</mo> <mo>R</mo> </semantics> </math>");
